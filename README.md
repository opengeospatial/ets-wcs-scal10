# OGC Web Coverage Service 2.0.1 Scaling Extension Test-Suite

The OGC Web Coverage Service 2.0.1 Scaling Extension Test-Suite provides the Executable Test Script (ETS) to test implementations against the following specification(s):
  ...
  * [WCS RSUB] [OGC Web Coverage Service 2.0 Interface Standard - Scaling Extension](https://portal.opengeospatial.org/files/12-039) (OGC 12-039)
  * Compliance Test Language (CTL) 0.5


Detailed information about this test suite is available [here](http://opengeospatial.github.io/ets-wcs-scal10/).
...
Issue tracker is available at [github](https://github.com/opengeospatial/ets-wcs-scal10/issues).
